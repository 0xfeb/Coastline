...
public extension String {
	...
	// 将最后一个Path项目从文件目录中删除
	public func popLastPath() -> String {
	...
	// 将文件名更换一个后缀名
	public func newExt(_ ext:String) -> String {
		if ext.hasSuffix(".") { return withOutExt + ext }
		return withOutExt + "."+ext
	}
	
	// 根据主体和后缀名自动生成新的后缀名
	public func unusedFileName(main:String, ext:String) -> String {
